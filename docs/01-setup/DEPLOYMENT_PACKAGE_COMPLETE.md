...
[2/9] Creating virtual environment...
  ✓ Virtual environment created
[3/9] Installing dependencies...
  ℹ Installing core dependencies...
  ✓ Core dependencies installed
  ℹ Attempting TensorFlow installation...
  ⚠ TensorFlow not available for Python 3.14.0
    ML features will be limited
  ℹ Skipping editable install (requires MT5)
  ✓ Installation complete (MT5 skipped - Windows only)
[4/9] Checking MetaTrader5...
  ℹ MetaTrader5 not available (Windows only)
    This is expected on macOS/Linux
    You can test the database layer and run unit tests
[5/9] Configuring environment...
  ✓ Created .env file from template
[6/9] Initializing database...
  ✓ Database initialized successfully
[7/9] Skipping tests (--skip-tests flag)
[8/9] Verifying Python imports...
  ✓ Python modules can be imported
  ℹ CLI commands not available (requires editable install with MT5)
[9/9] Setup complete!
