...
def trade_server_return_code_description(return_code: int) -> str:
    ...
    Args:
        return_code: MT5 trade server return code
    ...
    return descriptions.get(return_code, f"Unknown return code: {return_code}")
...
def error_description(err_code: int) -> str:
    ...
    return descriptions.get(err_code, f"Unknown error: {err_code}")
